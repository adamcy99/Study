...
# i and j (where 0 ≤ i < j < a.length), such that a[i] and a[j] are digit anagrams.
...
# 220 and 22 are also not considered as digit anagrams, since they don't even have the 
